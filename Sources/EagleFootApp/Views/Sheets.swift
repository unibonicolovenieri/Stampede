...
struct SavePresetSheet: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text("Finisce in ~/.config/eaglefoot/presets e sarà utilizzabile anche da terminale "
                 + "con `eaglefoot apply --preset \(cleanName.isEmpty ? "nome" : cleanName)`.")
                .font(.caption)
