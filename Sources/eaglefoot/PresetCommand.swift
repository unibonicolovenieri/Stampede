...
struct PresetCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        ~/.config/eaglefoot/presets. Sono normali file JSON: puoi versionarli,
    ...
    struct List: ParsableCommand {
        ...
        func run() throws {
            ...
            guard !entries.isEmpty else {
                print("Nessun preset. Creane uno con: eaglefoot apply … --save-preset <nome>")
                return
            }
    ...
    struct Save: ParsableCommand {
        ...
        @Flag(name: .customLong("project"), help: "Salva in ./presets invece che in ~/.config/eaglefoot/presets.")
